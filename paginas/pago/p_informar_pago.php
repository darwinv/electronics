		...
		<div class="container">
			<div class="contenedor pad20 marB20 sombra-div">
				<h4 class="mar0">Datos para concretar compra</h4>
				<span class="color-emp t14 neg1" >Horarios de atencion, Lunes a Viernes 8am a 5pm.</span>
				<hr>
				<br>
				<br>
			<div class="row">
			...
			<div class="contenedor text-justify pad20 marB20 sombra-div" >
				<span class=" t20"> Informacion para los comppradores</span>
				<br>
				<hr>
				<br>
				<span class="grisC t16">Los pedidos se despachan a traves de ZOOM (con cobro destino) de forma asegurada, en un lapso de 24 horas Habiles, contadas a partir del registro de tu orden en nuestro formulario digital</span>
			</div>
