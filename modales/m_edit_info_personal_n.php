<div class="modal fade bs-example-modal-lg modal-conf in" data-type="personal" tabindex="-1" role="dialog"
	aria-labelledby="myLargeModalLabel" id="info-personal" name="info-personal">
